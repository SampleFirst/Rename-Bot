...
DB_NAME = os.environ.get("DB_NAME", "mongodb+srv://Rename1:Rename1@cluster0.u6r0yti.mongodb.net/?retryWrites=true&w=majority")
DB_URL = os.environ.get("DB_URL", "Rename1")
